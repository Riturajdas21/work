...
print("\n Enter the input \n for pass please enter 0 ")


target=[]
t=[]
print( "please enter -1 for end target line")
...
os.remove("codon.txt")
choice=0
for faulty in range(0,gate_No):
    print("For Faulty at gate No. ",faulty+1,"\n")
    t1_start = time.time() 
    g1=g.copy()
    for i in range(0,inputline):
        g1[faulty][i]=1
    ...
    codonarr2= compute(duplicate_codon,codon_binary,g1,inputline,gate_No)
    f1=open("codon.txt","r")
    codonlist1=[]
    for x in f1:
        codonlist1.append(x)
    ...
    print("Runtime of the program is", t1_stop-t1_start) 
